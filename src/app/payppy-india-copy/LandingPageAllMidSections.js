...
function LandingPageAllMidSections() {
    ...
    //     tl2.to(image.current,{
    //         rotate:-45
    //     },'a')
    //     tl2.to(heading.current,{
    //         rotate:45
    //     },'a')
    // })
  ...
  return (
    <>
        {/* section one  */}
        <section ref={container} className={'landing-page-section-one flex flex-col-reverse lg:flex-row  items-center justify-center gap-20 md:gap-28 pt-20 lg:p-20 '+plus_jakarta_sans.className}>
            ...
            <main className='landing-section-one-info flex flex-col items-center items-center lg:items-start gap-3 md:gap-6' ref={heading}>
                {/* <div> */}
